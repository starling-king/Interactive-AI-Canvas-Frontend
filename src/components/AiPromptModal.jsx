...
// //     const { jobStatus, resetAiState } = useAiStore((state) => ({
...
//     // Pull resetAiState to kill the loop
//     const { jobStatus, resetAiState } = useAiStore((state) => ({
//         jobStatus: state.jobStatus,
//         resetAiState: state.resetAiState
//     }));
...
//     // THE FIX: Kill the infinite loop by resetting the state and ignoring the onClose reference change
//     useEffect(() => {
//         if (jobStatus === 'completed') {
//             setPrompt('');
//             onClose();
//             resetAiState(); // Immediately sets jobStatus back to 'idle' so this effect stops firing
//         }
...
export default function AiPromptModal({ isOpen, onClose, workspaceId }) {
    ...
    // FIX 1: Split the selectors to prevent object-reference infinite loops
